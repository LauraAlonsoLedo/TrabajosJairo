...
class NoticiaController
{
    ...
    public function activar($id){
        ...
        if ($noticia->activo == 1){
            ...
            ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                $this->view->redireccionConMensaje("admin/noticias","green","El vecino <strong>$noticia->nombre</strong> se ha desactivado correctamente.") :
            ...
            //Mensaje y redirección
            ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                $this->view->redireccionConMensaje("admin/noticias","green","El vecino <strong>$noticia->nombre</strong> se ha activado correctamente.") :
                $this->view->redireccionConMensaje("admin/noticias","red","Hubo un error al guardar en la base de datos.");
        }
    ...
    public function home($id){
        ...
        if ($noticia->home == 1){
            ...
            //Mensaje y redirección
            ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                $this->view->redireccionConMensaje("admin/noticias","green","El vecino <strong>$noticia->nombre</strong> ya no se muestra en la home.") :
                $this->view->redireccionConMensaje("admin/noticias","red","Hubo un error al guardar en la base de datos.");
        }
            ...
            //Mensaje y redirección
            ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                $this->view->redireccionConMensaje("admin/noticias","green","El vecino <strong>$noticia->nombre</strong> ahora se muestra en la home.") :
                $this->view->redireccionConMensaje("admin/noticias","red","Hubo un error al guardar en la base de datos.");
        }
    ...
    public function borrar($id){
        ...
        //Mensaje y redirección
        ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
            $this->view->redireccionConMensaje("admin/noticias","green","El vecino se ha borrado correctamente$texto_imagen.") :
            $this->view->redireccionConMensaje("admin/noticias","red","Hubo un error al guardar en la base de datos.");
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            if ($id == "nuevo"){
                ...
                //Mensaje y redirección
                $this->view->redireccionConMensaje("admin/noticias","green","El vecino <strong>$titulo</strong> se guardado correctamente.".$texto_img);
