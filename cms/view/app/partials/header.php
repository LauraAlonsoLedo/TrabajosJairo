...
<head>
    ...
    <title>Nuevos Vecinos de Animal Crossing New Horizons</title>
...
<nav>
    <div class="nav-wrapper">
        ...
        <a href="<?php echo $_SESSION['home'] ?>" class="brand-logo" title="Inicio">
            <img src="<?php echo $_SESSION['public'] ?>img/acnh.png" alt="Logo ACNH">
        </a>
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li>
                <a href="<?php echo $_SESSION['home'] ?>vecinos" title="Vecinos">Vecinos</a>
            </li>
            <li>
...
<main>
    ...
    <header>
        <h1><strong>Mi primer CMS</strong></h1>
        <h5>con POO, MVC, PHP y MySQL</h5>
    </header>
